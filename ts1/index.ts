...
const genProof = (
    ...
    return polyCommit(quotient, G2, srs)
}
...
const verifyViaEIP197 = (
    ...
    const g1Alpha = srsG1(2)[1]
    const g1r = G1.affine(G1.mulScalar(G1.g, index))
    ...
    const inputs = [
        ...
        {
            G1: G1.affine(G1.sub(g1r, g1Alpha)),
            G2: G2.affine(proof),
        },
        {
            G1: G1.affine(G1.neg(G1.g)),
            G2: value,
        },
    ]
...
const genVerifierContractParams = (
    ...
    return {
        ...
        value: [
            [
                '0x' + value[0][1].toString(16),
                '0x' + value[0][0].toString(16),
            ],
            [
                '0x' + value[1][1].toString(16),
                '0x' + value[1][0].toString(16),
            ]
        ],
        pk: [
                [
                    '0x' + pk[0][1].toString(16),
                    '0x' + pk[0][0].toString(16),
                ],
                [
                    '0x' + pk[1][1].toString(16),
                    '0x' + pk[1][0].toString(16),
                ]
            ]
    }
}
